...
#set data path
train_x_csv = '../data/train_x_numeric_rank.csv'
train_y_csv = '../data/train_y.csv'
test_x_csv = '../data/test_x_numeric_rank.csv'
...
test_result.to_csv('../result/test_result_xgb_rank.csv',index=None,encoding='utf-8')
...
feature_score_csv.to_csv('../data/rank_feature_score.csv',index=None,encoding='utf-8')